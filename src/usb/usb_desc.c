...
const uint8_t MyBOSDescr[] = {
     ...
     * wTotalLength=33 (LE), bNumDeviceCaps=1 */
    0x05, 0x0F, 0x21, 0x00, 0x01,
    /* MS OS 2.0 Platform Capability (DEVICE_CAPABILITY): bLength=28,
     ...
     * bMS_VendorCode=0x01, bAltEnumCode=0x00 */
    0x1C, 0x10, 0x05, 0x00, 0xDF, 0x60, 0xDD, 0xD8, 0x89, 0x45, 0xC7, 0x4C, 0x9C, 0xD2, 0x65, 0x9D,
    0x9E, 0x64, 0x8A, 0x9F, 0x00, 0x00, 0x03, 0x06, 0xB0, 0x00, 0x01, 0x00,
};
...
const uint8_t MyMSOS20DescrSet[] = {
    /* Set Header (10B) — dwWindowsVersion=Win8.1, wTotalLength=176 */
    0x0A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x06, 0xB0, 0x00,
    /* Config Subset Header (8B) — bConfigurationValue=1, wTotalLength=166 */
    0x08, 0x00, 0x01, 0x00, 0x01, 0x00, 0xA6, 0x00,
    /* Function Subset Header (8B) — bFirstInterfaceNumber=0, wSubsetLength=158 */
    0x08, 0x00, 0x02, 0x00, 0x00, 0x00, 0x9E, 0x00,
    /* Extended Compat ID Descriptor (20B) — wLength=20,
     * compatibleID="WINUSB", subCompatibleID=0 (8B)
     * 注: MS OS 2.0 Table 13 没有 bFirstInterfaceNumber/bReserved 字段 —
     *      接口编号由 Function Subset Header 里的 bFirstInterfaceNumber 指定. */
    0x14, 0x00, 0x03, 0x00, 0x57, 0x49, 0x4E, 0x55,
    0x53, 0x42, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00,
    /* Extended Properties Descriptor (130B) — Registry Property
     * wLength=130, wDescriptorType=4, wPropertyDataType=REG_MULTI_SZ(7),
     * wPropertyNameLength=42 ("DeviceInterfaceGUIDs" UTF-16LE),
     * wPropertyDataLength=78 ("{11962A0C-5AC3-4108-A44B-9BD46300FD30}" UTF-16LE + double null) */
    0x82, 0x00, 0x04, 0x00, 0x07, 0x00, 0x2A, 0x00,
    ...
    0x00, 0x00,
    0x4E, 0x00, 0x7B, 0x00, 0x31, 0x00, 0x31, 0x00,
    0x39, 0x00, 0x36, 0x00, 0x32, 0x00, 0x41, 0x00,
    0x30, 0x00, 0x43, 0x00, 0x2D, 0x00, 0x35, 0x00,
    0x41, 0x00, 0x43, 0x00, 0x33, 0x00, 0x2D, 0x00,
    0x34, 0x00, 0x31, 0x00, 0x30, 0x00, 0x38, 0x00,
    0x2D, 0x00, 0x41, 0x00, 0x34, 0x00, 0x34, 0x00,
    0x42, 0x00, 0x2D, 0x00, 0x39, 0x00, 0x42, 0x00,
    0x44, 0x00, 0x34, 0x00, 0x36, 0x00, 0x33, 0x00,
    0x30, 0x00, 0x30, 0x00, 0x46, 0x00, 0x44, 0x00,
    0x33, 0x00, 0x30, 0x00, 0x7D, 0x00, 0x00, 0x00,
};
